...
df = pd.DataFrame(columns=list(['套利时间','Spot现价','Spot数量','Spot价值','Fu开空量','Fu保证金','Fu未实现盈亏','Fu价值','交易成本']))
df.loc['btc',['Spot现价','Spot数量']] = [2]*2
df.to_csv('C:\\Users\\EDZ\\Desktop\\github\\trade\\币安\\永续套利\\text.csv',encoding="utf-8-sig") #df转csv
df01 = pd.read_csv('C:\\Users\\EDZ\\Desktop\\github\\trade\\币安\\永续套利\\text.csv',index_col=0) #df读取csv，用第一列为index
